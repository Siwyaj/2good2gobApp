...
public class Meat extends Fragment {
    ...
    public void MakeTable() {
        ...
        String[] meatArray = {"Gulderod","Bønner","Broccoli","Kartoffel","Pore","Tomat","Squash","Peberfrugt","Løg","Hvidløg", "Chili", "Champignon","Celleri", "Blomkål"};
        ...
        for (String alpha: alphabet) {
            ...
            for (int i=0; i<meatArray.length-1;i++){
                if (meatArray[i].startsWith(alpha)){
                    currentLetter.add(meatArray[i]);
                }
            }
            if (!currentLetter.isEmpty()){
                TextView letter = new TextView(getActivity());
                letter.setText(alpha);
                llMasterMeat.addView(letter);
                ...
                for (String s : currentLetter) {
                    ...
                    llMasterMeat.addView(letterGrid);
                }
            }
        }
